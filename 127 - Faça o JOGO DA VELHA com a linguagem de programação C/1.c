...
int main() {
    int opcao, jogo[5][5], jogador[3] = {1}, vitoria, jogadaValida, jogadas;
    char vitorioso;
    ...
    do {
        ...
        do {
            ...
            // jogada do jogador 1 e 2
            if(jogador[0] == 1) {
                printf("\nVez do jogador X, escolha a coordenada (linha e coluna): ");
                ...
                printf("\nVez do jogador O, escolha a coordenada (linha e coluna): ");
                scanf(" %d %d", &jogador[1], &jogador[2]);
                while(jogador[1] < 1 || jogador[1] > 3 || jogador[2] < 1 || jogador[2] > 3) {
                    printf("\nJogada invalida, escolha a coordenada (linha e coluna): ");
                    scanf(" %d %d", &jogador[1], &jogador[2]);
